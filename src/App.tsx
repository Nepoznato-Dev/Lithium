...
function Insights() {
  ...
  const exportData = () => { const blob = new Blob([JSON.stringify(outcomes, null, 2)], { type: 'application/json' }); const link = document.createElement('a'); link.href = URL.createObjectURL(blob); link.download = 'lithium-outcomes.json'; link.click(); URL.revokeObjectURL(link.href); };
